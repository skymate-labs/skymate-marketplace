...
{
  return (
    <div className={styles.nmmpy2p}>
      <div className={styles.c167ogxp}>
        <div className={styles.c119o44h}>
          <div className={styles.c1yo0219}>
            <div>
              <div className={styles.w1nwvqds}>
                <div className={styles.c1hzbei0}>
                  <div className={styles.e4zy5d}>
                    <div className={styles.s19omyoi}>
                      <div>
                        <div className={styles.cbdpsi8}>
                          <div>
                            <div className={styles.rd7fm2t}>
                                  ...
                                  <div className={styles.awuxh4x}>
                                    <div className={styles.cw9aemg}>
                                      <div className={styles.c14whb16}>
                                        <label className={styles.c39h6gc}>
                                          <input type="radio" name="categoryScroller" className={styles.h192l0gc} checked={false} />
                                        ...
                                        <label className={styles.c1rmt9x7}>
                                          <input type="radio" name="categoryScroller" className={styles.h192l0gc} />
                                          <div className={styles.c1abgzgs}>
                                            <span className={styles.c1ozl2w2}>
                                        ...
                                        <label aria-hidden="false" className={styles.c1rmt9x7}>
                                          <input type="radio" name="categoryScroller" className={styles.h192l0gc} />
                                          <div className={styles.c1abgzgs}>
                                            <span className={styles.c1ozl2w2}>
                                        ...
                                        <label aria-hidden="false" className={styles.c1rmt9x7}>
                                          ...
                                          <div className={styles.c1abgzgs}>
                                            <span className={styles.c1ozl2w2}>
                                              <img className={styles.i181yxiv} src="https://a0.muscache.com/pictures/c9157d0a-98fe-4516-af81-44022118fbc7.jpg" alt="" width="24" height="24" />
                                              <div className={styles.t192ua0c}>
                                                <span className={styles.ti7yjx}>Dammuso</span>
                                              </div>
                                            </span>
                                          </div>
                                        </label>
                                        ...
                                        <label aria-hidden="true" className={styles.c1rmt9x7}>
                                          <input type="radio" name="categoryScroller" className={styles.h192l0gc} />
                                          <div className={styles.c1abgzgs}>
                                            <span className={styles.c1ozl2w2}>
                                        ...
                                        <label aria-hidden="true" className={styles.c1rmt9x7}>
                                          ...
                                          <div className={styles.c1abgzgs}>
                                            <span className={styles.c1ozl2w2}>
                                              <img className={styles.i181yxiv} src="https://a0.muscache.com/pictures/827c5623-d182-474a-823c-db3894490896.jpg" alt="" width="24" height="24" />
                                              <div className={styles.t192ua0c}>
                                                <span className={styles.ti7yjx}>Ryokan</span>
                                              </div>
                                            </span>
                                          </div>
                                        </label>
                              ...
                              <div className={styles.t14s0ksq}>
                                <div className={styles.b1tv178t}>
                                <button aria-label="Trang danh mục tiếp theo" data-shared-element-id="next-button" type="button" className={styles.atm_2d_1hbpp16}>
                                  <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false">
                  ...
                  <div className={styles.f1wy08xg}>
                    <div className={styles.cocjyl3}>
                      <div className={styles.b14ijnw4}>
                        <button type="button" className={styles.l1ovpqvx}>
                          <span className={styles.i1prp6wh}>
                        ...
                        <div aria-hidden="true" className={styles.b597hka}>
                          <div className={styles.n1bnsfy}>0</div>
                        </div>
                      </div>
                    </div>
                  </div>
